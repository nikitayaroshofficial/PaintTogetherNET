...
{
    partial class AuthorizedTesterAuthForm
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AuthorizedTesterAuthForm));
            ...
            this.label1.Text = "Авторизация Тестировщиков";
            // 
            // label2
            // 
            ...
            this.Name = "AuthorizedTesterAuthForm";
            this.Text = ">> Yaroshium <<";
            this.TopMost = true;
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.AuthorizedTesterAuthForm_FormClosing);
